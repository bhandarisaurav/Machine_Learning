...
driver.get("http://system.deerwalkfoods.com")
time.sleep(10)
username = driver.find_element_by_id("txtUsername")
password = driver.find_element_by_id("txtPassword")

username.send_keys("saurav.bhandari@deerwalk.edu.np")
password.send_keys("Saurav00114#")

form = driver.find_element_by_name("btnLogin")
form.click()
driver.get("http://system.deerwalkfoods.com/Feedback.aspx")
time.sleep(10)
done = 0
